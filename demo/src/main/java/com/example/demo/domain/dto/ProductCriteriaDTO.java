...
public class ProductCriteriaDTO {
     ...
     private Optional<List<String>> mul_price;
     ...
     public Optional<List<String>> getMul_price() {
          return mul_price;
     }
     public void setMul_price(Optional<List<String>> mul_price) {
          this.mul_price = mul_price;
     }
